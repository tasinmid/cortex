      ...
      <div className="py-12 bg-cortex-navy">
        <div className="container mx-auto px-6">
          <div className="text-center">
            <h3 className="text-2xl font-bold text-cortex-white mb-4">Ready to Create Your Success Story?</h3>
            <p className="text-cortex-gray mb-6">Schedule a free consultation to start your AI transformation journey.</p>
            <a 
