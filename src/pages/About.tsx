          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-cortex-navy/30 rounded-2xl p-8 border border-cortex-blue/20">
                ...
                <div className="grid grid-cols-2 md:flex md:justify-center gap-3 md:gap-6 mb-8">
                  <a 
                    href="https://www.linkedin.com/in/tasinmid/" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 bg-[#0077B5] hover:bg-[#005885] text-white px-3 py-2 rounded-lg transition-all duration-300 text-sm"
                  >
                  ...
                  <a 
                    ...
                    className="flex items-center justify-center gap-2 bg-cortex-teal hover:bg-cortex-teal/80 text-white px-3 py-2 rounded-lg transition-all duration-300 text-sm"
                  >
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 bg-[#1877F2] hover:bg-[#166FE5] text-white px-3 py-2 rounded-lg transition-all duration-300 text-sm"
                  >
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 bg-gradient-to-r from-[#833AB4] via-[#FD1D1D] to-[#F77737] hover:opacity-80 text-white px-3 py-2 rounded-lg transition-all duration-300 text-sm"
                  >
